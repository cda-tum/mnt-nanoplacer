...
class QCAEnv8(gym.Env):
    ...
    def action_masks(self):
        ...
        if self.node_to_action[self.actions[self.current_node]] == "INPUT":
            ...
            if self.clocking_scheme == "2DDWave":
                ...
                possible_positions_nodes[self.layout_width - 1, loc.y:] = 0
                possible_positions_nodes[loc.x:, self.layout_height - 1] = 0
            elif self.clocking_scheme == "USE":
                possible_positions_nodes[0][:] = 0
        ...
        elif len(preceding_nodes) == 2 and self.clocking_scheme == "2DDWave":
    ...
    def route_path(self, preceding_node, path):
